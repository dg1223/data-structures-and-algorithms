...
Is a single node considered connected?
No. A 1-component is just an ordinary component.
'''
...
visited = set()
node_is_single = False
result = count_components(graph_1, 'A', visited)
connected_components = result if not node_is_single else result-1
...
visited = set()
node_is_single = False
result = count_components(graph_2, '0', visited)
connected_components = result if not node_is_single else result-1
print(f"{connected_components = }")
